...
Status: historical exploration. Superseded for implementation scope by [the implementation handoff](implementation-handoff.md). The original alternatives below remain context, not additional requirements.
